...
mapview::mapview(merida$ageb, legend = FALSE, col.regions = "#E01A59")
```
...
mapview::mapview(cdmx$ageb, legend = FALSE, col.regions = "#E01A59")
```
...
# Paso 3. verificar 
mapview::mapview(cdmx_agebs,legend = FALSE, col.regions = "#E01A59")
```
